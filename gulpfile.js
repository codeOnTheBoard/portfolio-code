...
function stylesColor() {
  return src(['app/scss/blue.scss', 'app/scss/yellow.scss', 'app/scss/pink.scss', 'app/scss/orange.scss', 'app/scss/green.scss'])
    .pipe(
      plumber({
...
exports.stylesColor = stylesColor;
...
exports.build = series(cleandest, stylesColor, styles, scripts, images, buildcopy);

exports.default = parallel(styles, stylesColor, scripts, picture, pages, browsersync, startwatch);
